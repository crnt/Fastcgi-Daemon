...
FASTCGI_CONFIG=/etc/fastcgi2/available/$1.conf
FASTCGI_NICE=/etc/fastcgi2/available/$1.nice
FASTCGI_ENV=/etc/fastcgi2/available/$1.env
FASTCGI_START=/etc/fastcgi2/available/$1.start
LOCKER=/var/run/fastcgi2/fastcgistart2.$1.pid
RDELAY=1
